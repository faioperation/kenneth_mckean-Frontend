    ...
    <div className="font-inter max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 ">
      ...
      {loading && (
        <div className="mb-4 p-4 bg-blue-50 border border-blue-200 rounded-lg flex items-center gap-3">
          ...
          <div>
            <p className="text-blue-900 font-semibold">Processing your request...</p>
            <p className="text-blue-700 text-sm">Please wait while we set things up.</p>
          </div>
        </div>
      )}
      ...
      <div className="shadow border border-gray-200 rounded-2xl p-4 sm:p-6 mb-8 bg-white">
        ...
        <div className="mt-6 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 ">
          <div className="flex flex-wrap items-center gap-3 sm:gap-4">
            <div className="size-[38px] sm:size-[42px] border border-gray-400 rounded-full flex items-center justify-center cursor-pointer">
              <FaLink className="text-black text-sm sm:text-base" />
            </div>

            <div className="flex flex-wrap items-center gap-3">
              <button className="flex items-center gap-2 px-4 sm:px-5 h-10 sm:h-11 rounded-full border border-gray-300 hover:bg-gray-50">
                <Globe size={16} className="text-gray-600" />
                <span className="text-sm sm:text-[15px] text-gray-700">Search in web</span>
              </button>

              <button className="flex items-center gap-2 px-4 sm:px-5 h-10 sm:h-11 rounded-full border border-gray-300 hover:bg-gray-50">
                <ImagePlus size={16} className="text-gray-600" />
                <span className="text-sm sm:text-[15px] text-gray-700">Create on Image</span>
              </button>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            <button
              ...
              disabled={loading}
              className={`size-[38px] sm:size-[42px] bg-black rounded-full flex items-center justify-center ${
                loading ? "opacity-70 cursor-wait" : "cursor-pointer hover:bg-gray-800"
              }`}
            >
              {loading ? (
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-6 lg:mb-[300px]">
        {features.map((item) => {
          ...
          return (
            <div
              key={item.id}
              className="border border-gray-200 rounded-2xl p-4 sm:p-5 bg-white hover:shadow-lg transition duration-300 cursor-default"
            >
