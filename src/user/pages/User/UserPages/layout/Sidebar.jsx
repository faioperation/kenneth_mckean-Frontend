    ...
    <>
      ...
      >
        <div className="flex h-screen flex-col">
          ...
          {/* Bottom */}
          <div className="p-4 flex flex-col justify-between md:gap-12 overflow-y-auto">
            {/* Projects */}
            <div>
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
          <div className="w-full max-w-lg bg-white rounded-2xl shadow-xl overflow-hidden text-black border border-gray-200">
            <div className="flex items-center justify-between p-5 border-b bg-gray-50">
              ...
              <button onClick={() => setSelectedProjectId(null)} className="p-1 hover:bg-gray-200 rounded-full">
                <IoClose size={24} />
              </button>
            </div>
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="space-y-3">
                <label className="block text-sm font-semibold text-gray-700">New Task Prompt</label>
                <textarea 
                  value={prompt}
                ...
                >
                  {createTaskMutation.isPending ? "Generating AI Response..." : "Create Task"}
                </button>
              </div>

              {/* Displaying Existing Tasks */}
              <div className="max-h-52 overflow-y-auto pt-4 border-t border-gray-100">
                <p className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-3">Project Tasks</p>
                {detailsLoading ? (
                  ...
                  <p className="text-sm text-gray-400 italic">No tasks created yet.</p>
                )}
              </div>
            </div>
          </div>
