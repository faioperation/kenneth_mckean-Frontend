...
const OTPVerification = () => {
     ...
     * If user pastes a 6-digit number, it fills all inputs automatically.
            ...
            <div className="w-full max-w-md bg-white rounded-2xl shadow-xl p-8 sm:p-10 border border-gray-100 text-center">
                    ...
                    <div className="flex justify-center gap-2 sm:gap-3">
                        ...
                        {otp.map((digit, index) => (
                            ...
                            <input
                                ...
                                onPaste={index === 0 ? handlePaste : undefined} // Allow paste on the first field
                ...
                <div className="mt-10 pt-6 border-t border-gray-100">
                    ...
                    <button
                        ...
                        className="text-xs text-gray-400 font-bold uppercase tracking-tighter flex items-center justify-center gap-2 w-full transition-all hover:text-black cursor-pointer"
