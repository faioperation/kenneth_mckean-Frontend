            ...
            <table className="w-full text-left border-collapse">
              ...
              <thead>
                <tr className="border border-[#2B7FFF33] bg-[#161b22]">
                  <th className="px-6 py-4 text-gray-400  font-medium text-sm">User Name</th>
                  <th className="px-6 py-4 text-gray-400  font-medium text-sm">Mail</th>
                  <th className="px-6 py-4 text-gray-400  font-medium text-sm">Plan</th>
                  <th className="px-6 py-4 text-gray-400  font-medium text-sm text-center">Action</th>
                </tr>
              </thead>
